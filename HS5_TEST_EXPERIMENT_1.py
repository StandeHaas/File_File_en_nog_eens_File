...
df = pd.read_csv('HS5_data_TEST_EXPERIMENT_1.csv')
q_data = {} # v/h
lst_Q = [] # v/hr_index
for i in range(1, 12):
...
cell_6 = Cell( 6, 6, lst_delta_l,q_data,lst_Q, lst_v_f,lst_K_cr, lst_K_j,lst_lambda,n = 0,r = False,r_index = 0,s = True,s_index = 7,B_cell = False, E_cell = False, RM = False, K_r = 0, VSL = False)
